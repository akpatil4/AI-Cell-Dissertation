...
if raw_img is not None:
    ...
    with col1:
        ...
        state["width"] = st.slider(r"$\textsf{\Large Width of Subsection (pixels)}$",  min_value=4,max_value=img_color.shape[1],step = 2, value=100,)
    ...
    with col2:
        ...
        state["height"] = st.slider(r"$\textsf{\Large Height of Subsection (pixels)}$",min_value=4,max_value=img_color.shape[0],step = 2, value=100)
        ...
        cv2.imwrite("temp_image.png",img_sub)
